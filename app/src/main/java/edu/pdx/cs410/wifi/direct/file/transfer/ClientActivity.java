...
public class ClientActivity extends Activity {
	...
	public final int port = 7900;
	public int udpCheck = 0;
    ...
    {        
    	...
    	{
    		//Server is running and stop button is presses( todo later)
    	}
    }
    ...
    //method to set a resultCode to shift control to udp

	public void sendFile1(View view) {
    ...
    public void sendFile(View view) {
    	...
    	if(!transferActive)
    	{
	        ...
	        else
	        {
	        	...
	        	clientServiceIntent.putExtra("udpCode", udpCheck);
